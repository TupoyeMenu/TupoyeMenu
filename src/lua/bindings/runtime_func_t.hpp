...
#define TYPEID_MATCH_STR_ELSEIF(var, T)                                  \
	...
	public:
		...
		uintptr_t make_jit_func(const asmjit::FuncSignature& sig, const asmjit::Arch arch, const user_pre_callback_t pre_callback, const user_post_callback_t post_callback, const uintptr_t target_func_ptr)
		{
			...
			cc.invoke(&pre_callback_invoke_node, (uintptr_t)pre_callback, asmjit::FuncSignature::build<bool, parameters_t*, uint8_t, return_value_t*, uintptr_t>());
			...
			cc.invoke(&post_callback_invoke_node, (uintptr_t)post_callback, asmjit::FuncSignature::build<void, parameters_t*, uint8_t, return_value_t*, uintptr_t>());
