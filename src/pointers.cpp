...
namespace big
{
	constexpr auto pointers::get_gta_batch()
	{
        ...
        // Ped Pool
        {
            ...
            [](memory::handle ptr)
            {
                g_pointers->m_gta.m_ped_pool = ptr.add(3).as<rage::GenericPool*>();
            }
        },
        // Vehicle Pool
        {
            ...
            [](memory::handle ptr)
            {
                g_pointers->m_gta.m_vehicle_pool = *(rage::VehiclePool**)(*(uintptr_t*)ptr.add(3).rip().as<uintptr_t>());
            }
        },
        // Prop Pool
        {
            ...
            [](memory::handle ptr)
            {
                g_pointers->m_gta.m_ped_pool = ptr.add(3).rip().as<rage::GenericPool*>();
            }
        },
        // Pickup Pool
        {
        ...
        {
            "LDEF",
            "40 55 48 8B EC 48 83 EC 60 48 8B 0D",
            [](memory::handle ptr)
            {
