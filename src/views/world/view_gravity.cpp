...
namespace big
{
	void view::gravity()
	{
		...
		{
			ImGui::SliderFloat("Gravity Level", &g.world.gravity.current_gravity, 0.f, 1000.f, "%.1f");

			static int selected_lunar_preset = 0;

			if (ImGui::Combo("Lunar Presets", &selected_lunar_preset, gravity_presets.data(), gravity_presets.size()))
			{
