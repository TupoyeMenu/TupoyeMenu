...
namespace big
{
	...
	void view::session_browser()
	{
		...
		if (ImGui::TreeNode("FILTERS"_T.data()))
		{
			...
			ImGui::SameLine(); components::help_marker("REGION_FILTER_DESC"_T);
			...
			ImGui::SameLine(); components::help_marker("LANGUAGE_FILTER_DESC"_T);
		...
		ImGui::SameLine(); components::help_marker("REPLACE_GAME_MATCHMAKING_DESC"_T);
