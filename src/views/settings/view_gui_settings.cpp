	...
	void view::gui_settings()
	{
		...
		if (g.window.ingame_overlay.show_indicators)
		{
			if (ImGui::TreeNode("Overlay Indicators"))
			{
				...
				ImGui::Checkbox("Show Aimbot", &g.window.ingame_overlay.ingame_overlay_indicators.show_aimbot);
				ImGui::Checkbox("Show Triggerbot", &g.window.ingame_overlay.ingame_overlay_indicators.show_triggerbot);
