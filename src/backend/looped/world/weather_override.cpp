...
namespace big
{
	...
	weather_override g_weather_override("weatheroverride", "Override Weather", "Overrides current weather. This is local and cannot be seen by other players.", g.world.override_weather);
}
