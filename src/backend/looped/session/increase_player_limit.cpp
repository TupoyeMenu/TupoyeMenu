...
namespace big
{
	...
	increase_player_limit g_increase_player_limit("32players", "Increase Player Limit", "Increases the maximum player limit from 30 to 32", g.spoofing.increase_player_limit);
}
