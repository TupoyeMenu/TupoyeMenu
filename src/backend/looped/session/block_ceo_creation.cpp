...
namespace big
{
	...
	block_ceo_creation g_block_ceo_creation("blockceos", "Block CEO Creation", "Prevents players from creating CEOs and MCs through the interaction menu. Players can still start organizations using the computers in business properties", g.session.block_ceo_creation);
}
