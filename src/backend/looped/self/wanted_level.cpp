...
namespace big
{
	...
	clear_wanted g_clear_wanted("clearwantedself", "Clear Wanted Level", "Clears your wanted level", 0);
	...
	never_wanted g_never_wanted("neverwanted", "Never Wanted", "Never Wanted", g.self.never_wanted);
