...
namespace big
{
	...
	vehicle_ability
	    g_vehicle_ability("modifyvehicleability", "Modify Vehicle Abilities", "Apply special characteristics to your vehicle.", g.vehicle.abilities.enabled);

	bool_command g_jump_ability("jumpability", "Jump", "Applies the Ruiner 2000's jumping-ability to your vehicle.",
	    g.vehicle.abilities.jump);
	bool_command g_rocket_ability("rocketability", "Rocket Booster", "Applies the Rocket Voltic's booster to your vehicle.",
	    g.vehicle.abilities.rocket);
	bool_command g_parachute_ability("parachuteability", "Parachute", "Applies the Ruiner 2000's parachute ability to your vehicle.",
	    g.vehicle.abilities.parachute);
	bool_command g_ramp_ability("rampability", "Ramp Buggy", "Applies the Ramp Buggy's collision data to your vehicle.",
