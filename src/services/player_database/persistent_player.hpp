...
namespace big
{
	...
	struct persistent_player
	{
		...
		NLOHMANN_DEFINE_TYPE_INTRUSIVE_WITH_DEFAULT(persistent_player, name, rockstar_id, block_join, block_join_reason, force_allow_join, is_modder, infractions, command_access_level)
	};
