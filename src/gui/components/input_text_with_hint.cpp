...
namespace big
{
	bool components::input_text_with_hint(const std::string_view label, const std::string_view hint, char* buf, size_t buf_size, ImGuiInputTextFlags flag, std::function<void()> cb)
	{
		bool returned = false;
